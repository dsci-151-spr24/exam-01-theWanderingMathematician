...
nycflights13::flights %>%
  ...
  geom_point() +
  facet_wrap(~ origin) +
  labs(title = "Airplane delays vs. daily temperature", subtitle = "in flights departing from NYC airports", x = "Average daily temperature", y = "Average daily departure delay", colour = "Airport of origin") +
  ylim(NA, 75)
```
